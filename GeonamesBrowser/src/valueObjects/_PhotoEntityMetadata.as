...
internal class _PhotoEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var nonDerivedProperties:Array = new Array("id", "owner", "secret", "server", "farm", "title", "ispublic", "isfriend", "isfamily");
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Photo");
        }
